                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            <h3 class="card-title">Feedback Forms</h3>
                            <h6 class="card-subtitle"> Customer meeting status  </h6>
                            <form class="form-horizontal m-t-40">
                                <div class="form-group">
                                    <label>Counsoler Name</label>
                                    <input type="text" class="form-control" value="" placeholder="Counsoler Name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Write About Customer Requirements</label>
                                ...
                                <div class="form-group row p-t-20">
                                    <div class="col-sm-4">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheck1">Agree for Study Visa</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck2">
                                            <label class="custom-control-label" for="customCheck2">Agree for Tourist Visa</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck3">
                                            <label class="custom-control-label" for="customCheck3">Agree for Family Visa</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck1">
                                            <label class="custom-control-label" for="customCheck1">Agree for Work Visa</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck2">
                                            <label class="custom-control-label" for="customCheck2">Agree for Tourist Visa</label>
