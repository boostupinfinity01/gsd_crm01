        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">Family Visa Form List</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Family Visa Form List</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Family Visa Form List</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $rec_sql = "SELECT fmy.*, u.`username` FROM family_form fmy JOIN users u ON u.user_id = fmy.assign_to WHERE fmy.action = 1 ";
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $rec_result['family_id']; ?></td>
                                                ...
                                                <td>
                                                    <a href="family_visa_edit.php?fmy_id=<?php echo $rec_result['family_id']; ?>" class="btn btn-success" id="family_edit_btn" > <i class="fa fa-edit"></i> Edit</a>
                                                    <a href="#" class="btn btn-danger" id="family_del_btn" data-id="<?php echo $rec_result['family_id']; ?>"> <i class="fa fa-trash"></i> Delete</a> 
                                                </td>
