                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate="" id="add_tourist_form">
                ...
                <div class="controls">
                    <input type="file" name="file" class="form-control" required=""> <div class="help-block"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="SHENEGAN" name="styled_destin" id="styled_desti10" class="custom-control-input">
                                                  ...
                                                  <select class="form-control" name="assign_to">
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($rec_query->num_rows > 0){
                                                           ...
                                                           while($rec_result1 = $rec_query-> fetch_assoc()){
                                                    ?>
                                                        <option value="<?php echo $rec_result1['user_id'];?>"> <?php echo $rec_result1['username']; ?> </option>
                                                    <?php 
                                                        }
                                                        }
                                                        else{
                                    ...
                                    <div class="text-xs-right">
                                        <button type="submit" class="btn btn-info" id="add_tourist">Submit</button>
