        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">IELTS Form List</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">IELTS Form List</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">IELTS Form List</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $rec_sql = "SELECT iel . * , u.`username` as assign_to_user, u1.`username` as created_by_user
                                                            FROM ielts_exam iel 
                                                            
                                                            INNER JOIN users u ON u.user_id = iel.assign_to 
                                                            INNER JOIN users u1 ON u1.user_id = iel.created_by
                                                            WHERE iel.`action` = 1 
                                                            ORDER BY ielts_id ASC";
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $rec_result['ielts_id']; ?></td>
                                                ...
                                                <td>
                                                    <a href="print_view.php?pte_id=<?php echo $rec_result['ielts_id']; ?>" class="btn btn-dark" id="pte_del_btn" data-id="<?php echo $rec_result['ielts_id']; ?>"> <i class="fa fa-search"></i> View</a>
                                                    <a href="pte-exam-edit.php?pte_id=<?php echo $rec_result['ielts_id']; ?>" class="btn btn-success" id="pte_edit_btn" > <i class="fa fa-edit"></i> Edit</a>
                                                    <a href="print_view.php?pte_id=<?php echo $rec_result['ielts_id']; ?>" class="btn btn-danger" id="pte_del_btn" data-id="<?php echo $rec_result['ielts_id']; ?>"> <i class="fa fa-trash"></i> Delete</a> 
