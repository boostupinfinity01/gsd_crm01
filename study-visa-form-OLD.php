                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate="" id="add_study_form">
                ...
                <div class="controls">
                    <input type="file" name="file" class="form-control" required=""> <div class="help-block"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="main_applicant_name" class="form-control" required="" data-validation-required-message="This field is required" maxlength="10">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="styled_desti3">NEWZEALAND</label>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti4" class="custom-control-input">
                                                        <label class="custom-control-label" for="styled_desti4">USA </label>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti5" class="custom-control-input">
                                                        <label class="custom-control-label" for="styled_desti5">DUBAI </label>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti6" class="custom-control-input">
                                                        <label class="custom-control-label" for="styled_desti6">SINGAPORE </label>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti7" class="custom-control-input">
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti7" class="custom-control-input">
                                                        <label class="custom-control-label" for="styled_desti7">THAILAND </label>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti7" class="custom-control-input">
                                                        <label class="custom-control-label" for="styled_desti7">EUROPE </label>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="2" name="styled_destin" id="styled_desti7" class="custom-control-input">
                                                        <label class="custom-control-label" for="styled_desti7">SHENEGAN ETC.</label>
                                                    </div>
                                                </fieldset> 
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="maxChar cnt1" class="form-control" required="" data-validation-required-message="This field is required" maxlength="10">
                                                <div class="help-block"></div></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="maxChar cnt2" class="form-control" required="" data-validation-required-message="This field is required" maxlength="10">
                                                <div class="help-block"></div></div>
                                                <div class="form-control-feedback"><small>Only Allow <code>maxlength='10'</code> Digit Contact maximum number. </small></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-xs-right">
                                        <button type="submit" class="btn btn-info study_add_btn" id="study_form_btn"> Submit </button>
                                        <button type="reset" class="btn btn-dark study_cncl_btn" id="study_cncl_btn"> Cancel </button>
                                    </div>
                                </form>
                            </div>
                        </div>
