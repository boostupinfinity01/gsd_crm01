                                ...
                                <form class="m-t-40" novalidate="" id="edit_pte_form" data-id="<?php echo $pte_result['pte_id'];?>">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="counselor_name" class="form-control" required="" data-validation-required-message="This field is required" aria-invalid="false"
                                              value="<?php echo $pte_result['counselor_name'];?>"> 
                                    ...
                                    <div class="form-group row p-t-20 p-b-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="mdate" placeholder="Last IELTS Admission Date" name="last_admission_date" value="<?php echo $pte_result['admission_date'];?>">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="full_addrs" id="textarea" class="form-control" required="" placeholder="Textarea text" rows="9" value="<?php echo $pte_result['full_address'];?>"></textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h5>Created By<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                <input type="text" name="last_ielts_score" class="form-control" required="" data-validation-required-message="This field is required" value="<?php echo $pte_result['total_band'];?>"/>    
                                                <div class="help-block"></div></div>
                                            </div>
