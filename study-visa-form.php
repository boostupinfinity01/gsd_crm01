            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input type="file" name="file" class="form-control" required=""> <div class="help-block"></div>
                                    ...
                                    <div class="form-group" >
                                        <h5>Name of Applicant <span class="text-danger">*</span></h5>
                                        <div class="controls" id="dynamic_field">
                                            <div class="input-group">
                                                <input type="text" name="applicant_add_name" class="form-control" data-validation-required-message="This field is required" >
                                                <div class="input-group-prepend">
                                                    <button class="btn btn-success" type="button" id="add_name_field"><i class="fa fa-plus"></i> Add New Field</button>
                                                </div>
                                            </div>
                                            <div class="help-block"></div> 
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="qualif" class="form-control" required="" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">     
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="exam_board" class="form-control" required="" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
                                        ...
                                        <div class="col-md-12">     
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="study_subj" class="form-control" required="" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
                                        ...
                                        <div class="col-md-12">     
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="pass_year" class="form-control" required="" id="passing_date" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
                                        ...
                                        <div class="col-md-12">     
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="pass_percent" class="form-control" required="" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
                                        ...
                                        <div class="col-md-12">     
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="total_gap" class="form-control" required="" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
                                        ...
                                        <div class="col-md-12">     
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="gap_experience" class="form-control" required="" data-validation-required-message="This field is required">
                                                <div class="help-block"></div></div>
