        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">ILETS Visa Form</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">ILETS visa form</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ILETS Visa Form</h4>
                                <h6 class="card-subtitle">Fill all required fields </h6>
                                <form class="m-t-40" novalidate="" id="add_ielts_form">
                                    ...
                                    <div class="form-group row p-t-20 p-b-10">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck1">ILETS Coaching</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 p-t-5">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customCheck2" value="1" name="why_join2"/>
                                                <label class="custom-control-label" for="customCheck2">ILETS Examination</label>
                                            </div>
                                        </div>
                                    </div>

                                        <div class="form-group">
                                            <h5>Last IELTS Course Admission Date <span class="text-danger">*</span></h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h5 class="m-b-20">Total Band (Your last IELTS Score)<span class="text-danger">*</span></h5>
                                                <div class="jumbotron-custom">
                                                    <div class="controls">
                                                        <h6 class="m-t-20">Overall last IELTS Score<span class="text-danger">*</span></h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12"><h5 class="m-t-20">Each last IELTS Score<span class="text-danger">*</span></h5></div>
                                                        <div class="col-md-3">
                                                            
                                                            <input type="text" name="listen_ielts_score" class="form-control" required="" data-validation-required-message="This field is required" value=""/>    
                                                            <h6 class="m-t-10">Listening<span class="text-danger">*</span></h6>
                                                            <div class="help-block"></div>
                                                        </div><!-- //col-md-3 -->
                                                        <div class="col-md-3">
                                                            
                                                            <input type="text" name="read_ielts_score" class="form-control" required="" data-validation-required-message="This field is required" value=""/>    
                                                            <h6 class="m-t-10">Reading<span class="text-danger">*</span></h6>
                                                            <div class="help-block"></div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            
                                                            <input type="text" name="write_ielts_score" class="form-control" required="" data-validation-required-message="This field is required" value=""/>    
                                                            <h6 class="m-t-10">Writing<span class="text-danger">*</span></h6>
                                                            <div class="help-block"></div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            
                                                            <input type="text" name="speak_ielts_score" class="form-control" required="" data-validation-required-message="This field is required" value=""/>    
                                                            <h6 class="m-t-10">Speaking<span class="text-danger">*</span></h6>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div><!-- // end row -->
                                                </div>
                                    ...
                                    <div class="text-xs-right">
                                        <button type="submit" class="btn btn-info add_iel_btn" id="iel_save_btn">Submit</button>
                                        <button type="reset" class="btn btn-dark cncl_iel_btn" id="iel_cncl_btn">Cancel</button>
                                    </div>
                                </form>
                            </div>
                        </div>
