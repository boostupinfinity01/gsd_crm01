                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $rec_sql = "SELECT r.*, u.`username` from reception_form r 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?uid=<?php echo $rec_result['id'];?>" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
                                                    <a href="#" class="btn btn-danger" data-id="<?php echo $rec_result['id'];?>"><i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                            <?php 
                                                }
