        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">Tourist Visa Form</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Tourist visa form</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tourist Visa Form</h4>
                                <h6 class="card-subtitle">Fill all required fields </h6>

                                <?php 
                                    $t_id = $_GET['t_id'];
                                    $tourist_visa_sql = "SELECT * from tourist_form WHERE tourist_id=".$t_id;
                                    $tourist_visa_query = $conn->query($tourist_visa_sql);
                                    
                                    if($tourist_visa_query->num_rows > 0){

                                        $tourist_visa_result = $tourist_visa_query-> fetch_assoc(); 
                                ?>
                                <form class="m-t-40" novalidate="" id="edit_tourist_form" data-id="<?php echo $tourist_visa_result['tourist_id'];?>">
                                    <div class="form-group">
                                        <h5>Counselor Name <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="counselor_name" class="form-control" required="" data-validation-required-message="This field is required" aria-invalid="false" value="<?php echo $tourist_visa_result['counselor_name'];?>"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="no_applicant" class="form-control" required="" data-validation-required-message="This field is required" aria-invalid="false" value="<?php echo $tourist_visa_result['no_of_applicant'];?>"> 
                                            <div class="help-block"></div>
                                        </div>
                                            <!-- <div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div> -->
                                    </div>
                ...
                <div class="controls">
                    <input type="file" name="file" class="form-control" required=""> <div class="help-block"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="main_applicant_name" class="form-control" required="" data-validation-required-message="This field is required" maxlength="10" value="<?php echo $tourist_visa_result['main_applicant']; ?>">
                                        <div class="help-block"></div></div>
                                    </div>

                                    <div class="form-group">
                                        <h5>Date of Birth <span class="text-danger">*</span></h5>
                                        <input type="text" class="form-control" id="mdate" placeholder="" name="cdob" value="<?php echo $tourist_visa_result['date_of_birth']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <h5>Passport No. <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="passport_no" class="form-control" required="" data-validation-required-message="This field is required" maxlength="7" value="<?php echo $tourist_visa_result['passport_no']; ?>">
                                        <div class="help-block"></div></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mdate1" placeholder="" name="event_date" value="<?php echo $tourist_visa_result['event_date']; ?>">
                                    </div>
                                    
                                    <?php
                                        $selected_dest = $tourist_visa_result['destination']; 
                                        //  echo $selected_dest;
                                    ?>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <fieldset class="controls">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="CANADA" name="styled_destin" id="styled_desti1" class="custom-control-input" 
                                                            <?php if($selected_dest == "CANADA"){ echo "checked=''"; } ?>>
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="AUSTRALIA" name="styled_destin" id="styled_desti2" class="custom-control-input" 
                                                            <?php if($selected_dest == "AUSTRALIA"){ echo "checked=''"; } ?>>
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="NEWZEALAND" name="styled_destin" id="styled_desti3" class="custom-control-input" 
                                                            <?php if($selected_dest == "NEWZEALAND"){echo "checked=''";} ?>>
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="USA" name="styled_destin" id="styled_desti4" class="custom-control-input" 
                                                            <?php if($selected_dest == "USA"){echo "checked=''";} ?>>
                                                ...
                                                <fieldset>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value="DUBAI" name="styled_destin" id="styled_desti5" class="custom-control-input" 
                                                            <?php if($selected_dest == "DUBAI"){echo "checked=''";} ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="cnt1" class="form-control" required="" data-validation-required-message="This field is required" maxlength="10" value="<?php echo $tourist_visa_result['contact_number_1']; ?>">
                                                <div class="help-block"></div></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="cnt2" class="form-control" required="" data-validation-required-message="This field is required" maxlength="10" value="<?php echo $tourist_visa_result['contact_number_2']; ?>">
                                                <div class="help-block"></div></div>
                                                <div class="form-control-feedback"><small>Only Allow <code>maxlength='10'</code> Digit Contact maximum number. </small></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="amnt_recv" class="form-control" required="" data-validation-required-message="This field is required" value="<?php echo $tourist_visa_result['amount_received']; ?>">
                                                <div class="help-block"></div></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="amnt_pend" class="form-control" required="" data-validation-required-message="This field is required" value="<?php echo $tourist_visa_result['amount_pending']; ?>">
                                                <div class="help-block"></div></div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="mgm_side" id="textarea" class="form-control" required="" placeholder="Textarea text" rows="9"> <?php echo $tourist_visa_result['any_mgm_side']; ?> 
                                                    </textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="any_refusal" id="textarea" class="form-control" required="" placeholder="Textarea text" rows="9"> <?php echo $tourist_visa_result['any_refusal']; ?>
                                                    </textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="travel_history" id="textarea" class="form-control" required="" placeholder="Textarea text" rows="9"> <?php echo $tourist_visa_result['any_travel_history']; ?>
                                                    </textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="govt_servant" id="textarea" class="form-control" required="" placeholder="Textarea text" rows="9"> <?php echo $tourist_visa_result['any_govt_servant']; ?>
                                                    </textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="any_remark" id="textarea" class="form-control" required="" placeholder="Textarea text" rows="9"><?php echo $tourist_visa_result['any_remarks']; ?>
                                                    </textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div>
                                    ...
                                    <?php $assigned_to = $tourist_visa_result['assign_to']; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                          ...
                                          <select class="form-control" name="assign_to">
                                            ...
                                            <?php 
                                                $tourist_sql = "select user_id,username from users";
                                                $tourist_query = $conn->query($tourist_sql);
                                                if($tourist_query->num_rows > 0){
                                                   
                                                   while($tourist_result = $tourist_query-> fetch_assoc()){
                                            ?>
                                                <option value="<?php echo $tourist_result['user_id'];?>" <?php if($assigned_to == $tourist_result['user_id']){echo "selected='selected'";} ?>> <?php echo $tourist_result['username']; ?> 
                                                </option>
                                            <?php 
                                                }
                                                }
                                    ...
                                    <div class="text-xs-right">
                                        <button type="submit" class="btn btn-info update_tourist_btn" id="visitor_edit_btn">Submit</button>
                                        <button type="reset" class="btn btn-dark cncl_tourist_btn" id="visitor_cncl_btn">Cancel</button>
                                    </div>
                                </form>
