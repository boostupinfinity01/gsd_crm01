        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">Study Visa Form List</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Study Visa Form List</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Study Visa Form List</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                /*$rec_sql = "SELECT s.*, u1.`username` as created_by_user
                                                            FROM study_visa s 
                                                            JOIN users u1 ON u1.user_id = s.created_by
                                                            WHERE s.action = 1 ORDER BY study_id ASC";*/
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $rec_result['study_id']; ?></td>
